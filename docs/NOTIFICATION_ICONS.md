...
These files are **committed to git** and regenerated by scripts when needed.
...
### Version Control
- ✅ Commit generated icons in `android/app/src/main/res/drawable-*/` and `android/app/src/main/res/mipmap-*/`
